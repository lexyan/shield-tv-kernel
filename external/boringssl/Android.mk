...
# TOS Specific BoringSSL module
include $(CLEAR_VARS)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := libtos_boringssl
LOCAL_MULTILIB := 32
...
LOCAL_C_INCLUDES := $(TEGRA_TOP)/ote/lib/external/libc/include

LOCAL_CFLAGS := -nostdinc -nostdlib -fno-stack-protector -Wno-empty-body
LOCAL_CFLAGS += -Wno-unused-parameter
# The TLK Boringssl variant requires the same restrictions as the Trusty variant
LOCAL_CFLAGS += -DTLK -DTRUSTY
...
LOCAL_SRC_FILES := $(filter-out src/crypto/rand/windows.c,$(LOCAL_SRC_FILES))
